  ...
  return (
    <>
      <div className={classNames(classesSection.marginTop, classes.root)}>
        ...
        <div className={classes.textContainer}>
          ...
          <sub className={classes.sub}>
            Не думайте над правильными формулировками, пишите, как есть.
            <br />
            Если понимаете, какой нужен результат от выполненной работы, тоже
            укажите.
          </sub>
          <div className={classes.ctaContainer}>
            <img src={arrowDown} className={classes.arrowDownImage} />
            <p className={classesPashaSection.p}>Напишите задачи в эту форму</p>
            <ButtonTasks />
          </div>
          <p className={classesSection.p}>Мы свяжемся в чате Телеграм, чтобы</p>
          <p className={classesSection.text}>
            <ol>
              <li>
                правильно определить КТО вам нужен и можете ли вы себе позволить
                такого человека
              </li>
              <li>дать ясные формулировки задачам нового сотрудника</li>
              <li>
                составить представление о вашей компании, команде и продукте
              </li>
              <li>определить результат совместной работы</li>
            </ol>
          </p>
          <sub className={classes.sub}>
            Можно выбрать чат или звонок. На обсуждение уйдет не более 30 минут.
          </sub>
          <p className={classesPashaSection.p}>
            В течение 24 часов вы получите подходящую под задачи должность,
            готовый текст вакансии, тестовое задание и вопросы для собеседования
          </p>
        </div>
      </div>
      ...
      >
        ...
        формальных, неискренних и халтурных текстов вакансий с нашей стороны не
        ждите!
      </p>
    </>
  );
